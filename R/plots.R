...
#                            ylim  = c(2,6),     ylab  = "lsmean",
#                            xlab  = NULL)
#' @title       plot (multiple) lsmeans results
#' @param       res.lm      result of lm()
#' @param       SNPnames    ID of SNPs
#' @param       nSNPs       number of SNPs
#' @param       mfrow       plot parameter. See par()
#' @param       mar         plot parameter. See par()
#' @param       ylim        The y-axis range
#' @param       xlab,ylab   Parameters passed to plot.default() 
#' @return      NULL
# -----------------------------------------------------------------------------
